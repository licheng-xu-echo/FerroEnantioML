...
if [ $derivs == "2" ] ; then
    echo "Running: xtb mol.xyz --chrg $charge --uhf $uhf --gfn2 --hess --grad > xtbout"
    xtb mol.xyz --chrg $charge --uhf $uhf --gfn2 --hess --grad > xtbout
elif [ $derivs == "1" ] ; then
    echo "Running: xtb mol.xyz --chrg $charge --uhf $uhf --gfn2 --grad > xtbout"
    xtb mol.xyz --chrg $charge --uhf $uhf --gfn2 --grad > xtbout
fi
